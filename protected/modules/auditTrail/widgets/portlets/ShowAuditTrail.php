...
class ShowAuditTrail extends CPortlet
{
    ...
    /**
     * @var InquirerModule static variable to hold the module so we don't have to instantiate it a million times to get config values
     */
    ...
    protected function getFromConfigOrObject($value)
    {
        ...
        if (!is_object(self::$__auditTrailModule)) {
            self::$__auditTrailModule = new InquirerModule(microtime(), null);
        }
